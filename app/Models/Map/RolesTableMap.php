...
use Maxters\Models\Roles;
use Maxters\Models\RolesQuery;
...
class RolesTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\Maxters\\Models\\Roles';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID, RolesTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID => 0, RolesTableMap::COL_NAME => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Maxters\\Models\\Roles');
        $this->setPackage('');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Maxters\Models\Roles) { // it's a model object
