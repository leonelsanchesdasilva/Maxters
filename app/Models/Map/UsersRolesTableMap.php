...
namespace Maxters\Models\Map;

use Maxters\Models\UsersRoles;
use Maxters\Models\UsersRolesQuery;
...
class UsersRolesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.UsersRolesTableMap';
     ...
     */
    const OM_CLASS = '\\Maxters\\Models\\UsersRoles';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'UsersRoles';
     ...
     */
    const COL_USER_ID = 'users_roles.user_id';

    /**
     * the column name for the role_id field
     */
    const COL_ROLE_ID = 'users_roles.role_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UsersRolesTableMap::COL_USER_ID, UsersRolesTableMap::COL_ROLE_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UsersRolesTableMap::COL_USER_ID => 0, UsersRolesTableMap::COL_ROLE_ID => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Maxters\\Models\\UsersRoles');
        $this->setPackage('');
    ...
    {
        $this->addRelation('User', '\\Maxters\\Models\\User', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \Maxters\Models\UsersRoles $obj A \Maxters\Models\UsersRoles object.
     ...
     *
     * @param mixed $value A \Maxters\Models\UsersRoles object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Maxters\Models\UsersRoles) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Maxters\Models\UsersRoles object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? UsersRolesTableMap::CLASS_DEFAULT : UsersRolesTableMap::OM_CLASS;
    }
    ...
    {
        $key = UsersRolesTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = UsersRolesTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + UsersRolesTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = UsersRolesTableMap::OM_CLASS;
            /** @var UsersRoles $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            UsersRolesTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = UsersRolesTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = UsersRolesTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UsersRolesTableMap::COL_USER_ID);
            $criteria->addSelectColumn(UsersRolesTableMap::COL_ROLE_ID);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(UsersRolesTableMap::DATABASE_NAME)->getTable(UsersRolesTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(UsersRolesTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(UsersRolesTableMap::TABLE_NAME)) {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Maxters\Models\UsersRoles) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(UsersRolesTableMap::DATABASE_NAME);
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(UsersRolesTableMap::COL_USER_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(UsersRolesTableMap::COL_ROLE_ID, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = UsersRolesQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            UsersRolesTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                UsersRolesTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return UsersRolesQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a UsersRoles or Criteria object.
     *
     * @param mixed               $criteria Criteria or UsersRoles object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from UsersRoles object
        }
...
//
UsersRolesTableMap::buildTableMap();
